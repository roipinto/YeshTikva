...
const ReactFirebaseFileUpload1 = () => {
    ...
    const handleUpload = () => {
        ...
        const uploadTask = storage.ref(`images/1.JPG`).put(image);
        uploadTask.on(
            "state_changed",
            snapshot => {
    ...
    function handleDelete() {
        console.log("delete")
        var storageRef = storage.ref("images/");
        var desertRef = storageRef.child('1.JPG');
    ...
    return (
        <div>
            ...
            <div class="alert alert-warning">
                <strong> ערוך תמונה ראשונה שמופיעה בדף הבית</strong>
            </div>
            ...
            <br />
            <img id="1" width="460" height="360" src={url || "http://via.placeholder.com/300"} alt="firebase-image" />
...
export default ReactFirebaseFileUpload1;